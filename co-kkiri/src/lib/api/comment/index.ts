...
import {
  CommentApiRequestDto,
  CommentApiResponseDto,
  CreateCommentApiRequestDto,
  ModifyCommentApiRequestDto,
} from "./type";

/** 댓글 목록 가져오기 */
export const getCommentList = (postId: number, qs: CommentApiRequestDto): Promise<CommentApiResponseDto> =>
